...
import Step2 from '@/icons/CreateCourse/Step3'
import Step3 from '@/icons/Term'
import Step4 from '@/icons/Payment'
import useInstructorSetup from '@/hooks/useInstructorSetup'

const steps = [
  { id: 1, label: 'Personal Information', icon: <Step1></Step1> },
  { id: 2, label: 'Profile image', icon: <Step2></Step2> },
  { id: 3, label: 'Instructor terms', icon: <Step3></Step3> },
